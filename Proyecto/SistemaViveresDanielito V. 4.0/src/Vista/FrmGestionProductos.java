...
public class FrmGestionProductos extends javax.swing.JFrame {
    ...
    SetImageLabel(agregar, "/imagenes/agregar.png");
        ...
        // ojo: aqui antes habia un "jLabel6.setVisible(false)" que ocultaba
        // el titulo "Gestión de Productos" de la pantalla. parece que se
        // copio y pego de FrmProducto.java (ahi jLabel6 es otra cosa, el
        // texto "Codigo de Producto") y nunca se quito. se elimino para que
        // el titulo de la pantalla se vea como deberia.
        // ojo: btnBuscar y txtBuscar antes se ocultaban aqui con setVisible(false),
        // a pesar de que el buscador SI esta conectado y SI funciona (ver
        // ControladorGestionP.buscarPorNombre). o sea que la funcion de
        // busqueda estaba 100% lista pero el usuario nunca podia llegar a
        // usarla porque los controles ni se veian. se dejan visibles.
    }
    ...
    private void initComponents() {
        ...
        txtBuscar.setToolTipText("Escriba el nombre o prefijo del producto a buscar");
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 180, 230, 32));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 180, 100, 32));
