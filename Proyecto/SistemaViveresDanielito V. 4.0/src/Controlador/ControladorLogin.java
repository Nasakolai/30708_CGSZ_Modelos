...
public class ControladorLogin implements ActionListener {
    ...
    public void iniciarSesion() {
        ...
        // chequeo extra por si las dudas: si por alguna razon el campo se
        // quedo con el texto de ejemplo (placeholder) en vez de lo que el
        // usuario escribio, lo tratamos como si estuviera vacio. esto es
        // un respaldo ademas del manejo de foco que ya limpia los campos.
        if (usuario.equals("Ingrese su nombre de usuario") || contraseña.equals("*********")) {
