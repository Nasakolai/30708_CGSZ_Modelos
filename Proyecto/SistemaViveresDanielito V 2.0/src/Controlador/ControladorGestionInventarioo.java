...
public class ControladorGestionInventarioo {
    ...
    private void configurarListeners() {
        ...
        vista.jButton3Guardar.addActionListener((ActionEvent e) -> guardarMovimiento());
        vista.jButtonLimpiar.addActionListener((ActionEvent e) -> limpiarFormulario());
        vista.jButton1Cancelar.addActionListener((ActionEvent e) -> vista.dispose());
        vista.jButtonMenuPrincipal.addActionListener((ActionEvent e) -> vista.dispose());
    }
