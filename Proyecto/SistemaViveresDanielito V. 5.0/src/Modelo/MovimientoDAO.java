...
public class MovimientoDAO {
    ...
    public void añadirMovimiento(Movimiento m) {
        ...
        doc.put("responsable", m.getResponsable());
        doc.put("nombreProducto", m.getNombreProducto());
        doc.put("codigoProducto", m.getCodigoProducto());
        doc.put("motivo", m.getMotivo());
        doc.put("detalleMotivo", m.getDetalleMotivo());
    ...
    private Movimiento mapear(DBObject d) {
        ...
        m.setResponsable((String) d.get("responsable"));
        m.setNombreProducto((String) d.get("nombreProducto"));
        m.setCodigoProducto((String) d.get("codigoProducto"));
        m.setMotivo((String) d.get("motivo"));
        m.setDetalleMotivo((String) d.get("detalleMotivo"));
        return m;
    }
    ...
    public boolean actualizarMovimiento(Movimiento m) {
        ...
        try {
            ...
            nuevosDatos.put("responsable", m.getResponsable());
            nuevosDatos.put("nombreProducto", m.getNombreProducto());
            nuevosDatos.put("codigoProducto", m.getCodigoProducto());
            nuevosDatos.put("motivo", m.getMotivo());
            nuevosDatos.put("detalleMotivo", m.getDetalleMotivo());
