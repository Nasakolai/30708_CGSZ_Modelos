...
import Controlador.ControladorGestionProveedores;
...
/**
 * pantalla para gestionar el catalogo de proveedores: ver cuantos
 * productos tiene cada uno, agregar nuevos, renombrar o eliminar.
 * sigue la misma estetica (sidebar azul oscuro + encabezado) que el
 * resto de ventanas de la app.
 */
public class FrmGestionProveedores extends javax.swing.JFrame {
    ...
    public FrmGestionProveedores() {
        ...
        new ControladorGestionProveedores(this);
    }
    ...
    private void initComponents() {
        ...
        // tabla y botones propios de esta pantalla
        ...
        // --- menu lateral (igual que en todas las demas pantallas) ---
        ...
        salir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) { System.exit(0); }
        });
        ...
        btnSalir.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) { btnSalir.setBackground(Color.red); }
            public void mouseExited(java.awt.event.MouseEvent evt)  { btnSalir.setBackground(new java.awt.Color(0, 38, 102)); }
        });
        ...
        btnSalirLayout.setHorizontalGroup(btnSalirLayout.createParallelGroup().addComponent(txtSalir, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE));
        btnSalirLayout.setVerticalGroup(btnSalirLayout.createParallelGroup().addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnSalirLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(txtSalir, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)));

        javax.swing.GroupLayout headerLayout = new javax.swing.GroupLayout(header);
        header.setLayout(headerLayout);
        headerLayout.setHorizontalGroup(headerLayout.createParallelGroup().addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup().addGap(0, 946, Short.MAX_VALUE).addComponent(btnSalir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
        headerLayout.setVerticalGroup(headerLayout.createParallelGroup().addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(btnSalir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));

        jPanel1.add(header, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 50));

        // logo clickeable (vuelve al menu principal)
        ...
        // --- botones de accion ---
        configurarBoton(btnAgregar,   "Agregar Proveedor",  290, 600, 165, 40);
        configurarBoton(btnTelefono,  "Editar Teléfono",    465, 600, 165, 40);
        configurarBoton(btnRenombrar, "Renombrar",          640, 600, 165, 40);
        configurarBoton(btnEliminar,  "Eliminar",           815, 600, 165, 40);

        jPanel1.add(btnAgregar,   new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 600, 165, 40));
        jPanel1.add(btnTelefono,  new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 600, 165, 40));
        jPanel1.add(btnRenombrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 600, 165, 40));
        jPanel1.add(btnEliminar,  new org.netbeans.lib.awtextra.AbsoluteConstraints(815, 600, 165, 40));
    ...
    // helpers de construccion del menu (para no repetir 5 veces el mismo bloque)
    ...
    private void configurarBoton(javax.swing.JButton btn, String texto, int x, int y, int w, int h) {
    ...
    private void txtAgregarClick() {
        ...
        new ControladorProducto(v, new Modelo.ProductoDAO()); v.setVisible(true); v.setLocationRelativeTo(null); dispose();
    }
