...
public class FrmProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione un tipo" }));
        ...
        jPanel2.add(CmbTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 310, 40));

        // boton para agregar una categoria nueva sin tocar el codigo
        btnNuevaCategoria = new javax.swing.JButton();
        btnNuevaCategoria.setBackground(new java.awt.Color(82, 126, 204));
        btnNuevaCategoria.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
        btnNuevaCategoria.setForeground(java.awt.Color.WHITE);
        btnNuevaCategoria.setText("+ Nueva");
        btnNuevaCategoria.setToolTipText("Agregar una nueva categoria de producto");
        btnNuevaCategoria.setBorder(null);
        btnNuevaCategoria.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel2.add(btnNuevaCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 200, 90, 40));

        // el proveedor ahora es un combo de solo seleccion (igual que el
        // tipo/categoria): la lista de proveedores solo se puede modificar
        // desde Gestion de Proveedores, no desde este formulario.
        ...
        txtProveedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una opción" }));
        txtProveedor.setSelectedItem("Seleccione una opción");
        txtProveedor.setToolTipText("seleccionar");
